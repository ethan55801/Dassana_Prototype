...
const translations = {
  en: {
    ...
    lensEyebrow: 'Why DASSANA?',
    lensTitle: 'Research with<br /><em>relevance.</em>',
    whyCopy: 'DASSANA transforms rigorous research on religion, Buddhism, belief, society, and history into clear, accessible insight.<br /><br />Its consultancy work combines academic sources, textual and historical research, and cultural and religious sensitivity to deliver evidence-based content with depth and relevance.<br /><br /><em class="why-highlight">Not just what people believe&mdash;but how beliefs emerge, evolve, and shape society.</em>',
  ...
  my: {
    ...
    lensEyebrow: 'Why DASSANA?',
    lensTitle: 'သုတေသနနှင့်<br /><em>သက်ဆိုင်မှုရှိသော အမြင်။</em>',
    whyCopy: 'DASSANA သည် ဘာသာရေး၊ ဗုဒ္ဓဘာသာ၊ ယုံကြည်မှု၊ လူမှုအဖွဲ့အစည်းနှင့် သမိုင်းဆိုင်ရာ တိကျခိုင်မာသော သုတေသနများကို ရှင်းလင်းလွယ်ကူပြီး အဓိပ္ပါယ်ရှိသော သိမြင်နားလည်မှုအဖြစ် ပုံဖော်ပေးပါသည်။<br /><br />အကြံပေးဝန်ဆောင်မှုတွင် ပညာရပ်ဆိုင်ရာ ရင်းမြစ်များ၊ စာပေနှင့် သမိုင်းသုတေသန၊ ယဉ်ကျေးမှုနှင့် ဘာသာရေးဆိုင်ရာ ထိလွယ်ရှလွယ်မှုတို့ကို ပေါင်းစပ်၍ အထောက်အထားအခြေပြု၊ နက်ရှိုင်းပြီး သက်ဆိုင်မှုရှိသော အကြောင်းအရာများကို ပေးအပ်ပါသည်။<br /><br /><em class="why-highlight">လူတွေ ဘာကို ယုံကြည်ကြသလဲဆိုတာသာမက—ယုံကြည်မှုတွေ ဘယ်လိုပေါ်ပေါက်၊ ပြောင်းလဲလာပြီး လူ့အဖွဲ့အစည်းကို ဘယ်လိုပုံဖော်သလဲဆိုတာကိုပါ လေ့လာပါသည်။</em>',
...
let currentLanguage = ['en', 'my'].includes(savedLanguage) ? savedLanguage : 'en';

function setLanguage(language) {
  currentLanguage = ['en', 'my'].includes(language) ? language : 'en';
...
const sectionLinks = Array.from(document.querySelectorAll('.site-nav > a:not(.nav-cta)[href^="#"]'));
